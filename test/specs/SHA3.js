...
describe("sha3", function(){
  it("digest '' with outputLength:512 as expected", function(){
    expect(SHA3.hash("", 512).toString()).to.be("0eab42de4c3ceb9235fc91acffe746b29c29a8c366b7c60e4e67c466f36a4304c00fa9caf9d87976ba469bcbe06713b435f091ef2769fb160cdab33d3670680e");
  });
  it("digest a message with outputLength:512 as expected", function(){
    ...
    expect(SHA3.hash(message, 512).toString()).to.be(expectedResult);
  });
  ...
  it("digest '' with outputLength:384 as expected", function(){
    ...
    expect(SHA3.hash("", 384).toString()).to.be(expectedResult);
  });
  it("digest a message with outputLength:384 as expected", function(){
    ...
    const message = Hex.parse("");
    expect(SHA3.hash(message, 384).toString()).to.be(expectedResult);
  });
  ...
  it("digest '' with outputLength:256 as expected", function(){
    ...
    expect(SHA3.hash("", 256).toString()).to.be(expectedResult);
  });
  it("digest a message with outputLength:256 as expected", function(){
    ...
    const message = Hex.parse("");
    expect(SHA3.hash(message, 256).toString()).to.be(expectedResult);
  });
  ...
  it("digest '' with outputLength:224 as expected", function(){
    ...
    expect(SHA3.hash("", 224).toString()).to.be(expectedResult);
  });
  it("digest a message with outputLength:224 as expected", function(){
    ...
    const message = Hex.parse("");
    expect(SHA3.hash(message, 224).toString()).to.be(expectedResult);
  });
